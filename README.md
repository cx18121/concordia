...
On a normal stock-tip forum like Wall Street Bets, anyone can claim a great track record and nobody checks. Concordia makes the forum the fund: members pool USDC and vote each week on what it buys, and every vote and score is recorded on-chain where anyone can recompute it. Voting power is half the capital you put in and half how accurate your past calls have been, so influence flows to the people who are consistently right, not the people who simply put in the most.
